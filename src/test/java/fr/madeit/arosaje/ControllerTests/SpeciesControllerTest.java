...
public class SpeciesControllerTest {
    ...
    public void testFindById() throws Exception {
        ...
        when(speciesService.findById(Mockito.any())).thenReturn(mockSpecies);
    ...
    public void testFindByName() throws Exception {
        ...
        when(speciesService.findByName(Mockito.any())).thenReturn(mockSpecies);
    ...
    public void testAddSpecies() throws Exception {
        Species mockSpecies = new Species();
        when(speciesService.addSpecies(Mockito.any())).thenReturn(mockSpecies);

        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(speciesController).build();

        mockMvc.perform(MockMvcRequestBuilders.post("/api/species/add")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
    ...
    public void testDeleteSpecies() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/species/delete/{id}", mockSpeciesId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
    ...
    public void testUpdateSpecies() throws Exception {
        Species mockSpecies = new Species();
        when(speciesService.updateSpecies(Mockito.any())).thenReturn(mockSpecies);

        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(speciesController).build();

        mockMvc.perform(MockMvcRequestBuilders.put("/api/species/update")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());}
}
